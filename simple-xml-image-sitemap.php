        ...
        if (wp_verify_nonce($_POST['nonce'], 'sixs_image_sitemap_generate')) {
            ...
            switch (sixs_image_sitemap_create()) {
                case -1:
                    ...
                    echo '<p>' . __('The image sitemap could not be saved to your wordpress folder.', 'simple-xml-image-sitemap') . '</p>';
...
function sixs_image_sitemap_create()
{
    ...
    $image_sitemap_url = ABSPATH . 'sitemap-images.xml';
    if (sixs_is_file_writable(ABSPATH) || sixs_is_file_writable($image_sitemap_url)) {
